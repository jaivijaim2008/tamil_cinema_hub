...
function getSecurityHeaders(request: NextRequest): Record<string, string> {
  ...
  const headers: Record<string, string> = {
    ...
    'Content-Security-Policy': [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://pagead2.googlesyndication.com https://adservice.google.com https://www.googletagservices.com https://googleads.g.doubleclick.net https://plausible.io",
