...
function getSecurityHeaders(request: NextRequest): Record<string, string> {
  ...
  const headers: Record<string, string> = {
    ...
    'Content-Security-Policy': [
      ...
      "media-src 'self'",
      "connect-src 'self' https://*.sanity.io https://api.groq.com https://generativelanguage.googleapis.com https://api.cerebras.ai https://openrouter.ai https://huggingface.co https://api.replicate.com https://plausible.io https://quge5.com https://*.monetag.com",
