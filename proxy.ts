...
function getSecurityHeaders(request: NextRequest): Record<string, string> {
  ...
  const headers: Record<string, string> = {
    ...
    'Content-Security-Policy': [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://plausible.io https://quge5.com https://*.monetag.com https://*.serving-sys.com https://*.adnxous.com",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
      "font-src 'self' https://fonts.gstatic.com",
      "img-src 'self' data: blob: https: http:",
      "media-src 'self'",
      "connect-src 'self' https://*.sanity.io https://api.groq.com https://generativelanguage.googleapis.com https://api.cerebras.ai https://openrouter.ai https://huggingface.co https://api.replicate.com https://plausible.io https://quge5.com https://6opo.com https://*.monetag.com https://*.serving-sys.com https://*.adnxous.com",
